...
const Transaction = () => {
    ...
    const defaultMemberReport = [
        ...
        "Bismark Achodo","achodobismark@gmail.com","09072235895","21-5-2020","Online"
    ]
    ...
    return(
        <DashboardLayout>
            <Typography>
                Show A list of all Available User
            </Typography>
            <Table rowLength={demoMemberReport.length} heading={[null,null,"Name","Email","Phone","Last Seen","Presence"]}>
